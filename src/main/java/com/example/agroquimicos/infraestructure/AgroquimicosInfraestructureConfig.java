package com.example.agroquimicos.infraestructure;
...
@Configuration
@Component("com.example.agroquimicos.domain")
@PropertySource("classpath:application.properties")
@EnableJpaRepositories(basePackages = "com.example.agroquimicos.infraestructure.*")
public class AgroquimicosInfraestructureConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        emf.setPackagesToScan(Agroquimicos.class.getPackage().getName());
